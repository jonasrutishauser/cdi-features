...
public class ArcInterceptedFeatureCreator {

    public static final String BINDING_SOURCE_CLASS = FeatureSelectorBindingSource.class.getName();
    public static final String FEATURE_INVOKER_CLASS = FeatureInvoker.class.getName();

    private ArcInterceptedFeatureCreator() {
    ...
    public static <T> T create(SyntheticCreationalContext<T> context, TypeLiteral<Instance<T>> instanceType,
        ...
        return FeatureCreator.create(ownBean, instance.handlesStream(), context::getInjectedReference,
                context.getInterceptionProxy());
    }

    @FeatureSelector
    private abstract static class FeatureSelectorBindingSource {}
}
